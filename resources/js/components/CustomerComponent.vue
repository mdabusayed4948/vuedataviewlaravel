<template>
    <div id="customer">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools" style="position: absolute; right: 1rem; top: .5rem">
                            <button class="btn btn-primary" @click="create">Add New <i class="fas fa-plus-circle"></i></button>
                            <button class="btn btn-primary" @click="reload">Refresh <i class="fas fa-sync"></i></button>
                        </div>
                    </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="customerModalLong" tabindex="-1" aria-labelledby="customerModalLabel" aria-hidden="true">
    ...
    export default {
        ...
        methods:{
            getData(){
                ...
                this.$Progress.start()
                axios.get('/vuedataviewlaravel/api/customers?page='+this.pagination.current_page)
                .then(response => {
            ...
            searchData(){
                //  start the progress bar
                this.$Progress.start()
                axios.get('/vuedataviewlaravel/api/search/customers/'+this.queryField+'/'+this.query+'?page='+this.pagination.current_page)
                .then(response => {
                    this.customers = response.data.data
                    this.pagination = response.data.meta
                    //  finish the progress bar
            ...
            store(){
                ...
                this.$Progress.start()
                this.form.busy = true
                this.form.post('/vuedataviewlaravel/api/customers')
                .then(response => {
                    this.getData()
                    ...
                    {
                        this.$Progress.finish()
                        this.$snotify.success('Customer Data Successfully Saved...','Success')
                    }else {
                        this.$Progress.fail()
